...
@section('content')
    ...
    <ul class="nav nav-tabs" role="tablist">
        <li ><a href="{{ url('links/index') }}">友链列表</a></li>
        <li class="active"><a href="">添加友链</a></li>
    </ul>

    <form class="form-horizontal" id="form" action="{{ url('links/add') }}" method="post" enctype="multipart/form-data">
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">社团图片</label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select class="js-example-basic-single form-control" name=url">
